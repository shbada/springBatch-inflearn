...
public class JpaCursorConfiguration {
    ...
    public Step jpaCursorStep1() {
        return stepBuilderFactory.get("jpaCursorStep1")
                ...
                .reader(jpaCursorCustomItemReader())
                .writer(jpaCursorCustomItemWriter())
                .build();
    }

    @Bean
    public JpaCursorItemReader<Customer> jpaCursorCustomItemReader() {
        ...
        return new JpaCursorItemReaderBuilder()
                ...
                .queryString("select c from Customer2 c where firstname like :firstname") // jpql
