...
public class ParallelStepConfiguration {
    ...
    public Flow parallelStepFlow1() {
        ...
        TaskletStep step = stepBuilderFactory.get("parallelStepStep1")
                .tasklet(parallelStepTasklet()).build();
    ...
    public Flow parallelStepFlow2() {
        ...
        TaskletStep step1 = stepBuilderFactory.get("parallelStepStep2")
                .tasklet(parallelStepTasklet()).build();

        TaskletStep step2 = stepBuilderFactory.get("parallelStepStep3")
                .tasklet(parallelStepTasklet()).build();
