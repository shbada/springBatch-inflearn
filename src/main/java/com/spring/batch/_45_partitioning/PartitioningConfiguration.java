...
public class PartitioningConfiguration {
    ...
    public Job partitioningJob() throws Exception {
        return jobBuilderFactory.get("partitioningJob")
                ...
                .start(partitioningMasterStep1())
                .build();
    }

    @Bean
    public Step partitioningMasterStep1() throws Exception {
        /*
         ...
         */
        return stepBuilderFactory.get("partitioningMasterStep1")
                // slaveStep 을 정의
    ...
    @Bean
    public ColumnRangePartitioner partitioningPartitioner() {
