...
public class JdbcPagingConfiguration {
    ...
    public Step jdbcPagingStep1() throws Exception {
        return stepBuilderFactory.get("jdbcPagingStep1")
                ...
                .reader(jdbcPagingCustomItemReader())
                .writer(jdbcPagingCustomItemWriter())
                .build();
    }

    @Bean
    public JdbcPagingItemReader<Customer> jdbcPagingCustomItemReader() throws Exception {
   ...
   /* @Bean
    public JdbcPagingItemReader<Customer2> customItemReader() {
    ...
    @Bean
    public ItemWriter<Customer> jdbcPagingCustomItemWriter() {
        return items -> {
